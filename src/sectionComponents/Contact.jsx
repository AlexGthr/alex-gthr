    ...
    <section id="contact" className="section">
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            ...
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                ...
                <h2 className="headline-2 lg:max-w-[12ch]">Contactez moi !</h2>

                <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch]">
                  Contactez-moi dès aujourd'hui pour discuter de futures opportunités et construire ensemble de nouveaux projets !
                </p>
            ...
            <form 
                action="https://getform.io/f/bwnngdma"
                method='POST' 
                className="xl:pl-10 2lx:pl-20"
            >
                ...
                <div className="mb-4">
                    ...
                    <textarea name="message" id="message" placeholder='Votre message ici ...' required className="text-field resize-y min-h-32 max-h-80"></textarea>
                </div>
